...
const Contact = () => {
  return (
    ...
    lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-y-0 lg:space-x-8' id="contact">
      <div className='flex justify-center items-center'>
        <ul className='space-y-4'>
          <li className='flex items-center'>
            <Image src={mail} alt="mail" className='h-[110px] w-auto mr-6' />
            <p className='text-xl'>baskarh54@gmail.com</p>
          </li>
        </ul>
      </div>
      ...
      <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
        ...
        <p className='text-white/70 mb-6'>Send me a message and let's connect!</p>
        <form className='space-y-4' action="https://getform.io/f/bdrnqydb" method="POST">
          <div className='grid grid-cols-2 gap-4'>
            ...
            <input type="phone" name="phone" className='bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='Phone no' />
          </div>
